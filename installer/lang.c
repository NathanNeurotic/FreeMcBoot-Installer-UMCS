static const char *DefaultLanguageStringTable[SYS_UI_MSG_COUNT] = {
    ...
    "Existing FMCB CNF found!\nDo you want to keep it? No Recommended.",
    ...
    "Install PS2BBL (PSX) on this memory card.",
...
static const char *DefaultLanguageLabelStringTable[SYS_UI_LBL_COUNT] = {
    ...
    "Rate:",
    "Time\nremaining:",
    "OSDMenu Install with Backdoor",
    "OSDMenu Install without Backdoor",
    ...
    "Install PS2BBL (PSX)",
    "Install PS2BBL-HDD",
    "Uninstall Existing System Update",
    "Exit",
    "B",
    "KB",
    "MB",
